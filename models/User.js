...
User.prototype.validate = function(){
    return new Promise(async (resolve,reject)=>{
        ...
        //Only if username is valid then check to if it is already taken or not :)
        ...
        //Only if email is valid then check to if it is already taken or not :)
...
User.prototype.login = function(){
    return new Promise((resolve,reject)=>{
        ...
        usersCollection.findOne({username:this.data.username}).then((attemptedUser)=>{
            ...
            reject("Please try again again later!!")
        })
    })
}
...
User.prototype.register = function(){
    return new Promise(async (resolve,reject)=>{
        //Step #1:Validate USee Data
        this.cleanUp();
        await this.validate();
    
        //Step #2: only if there is no validation errors
        //then save the user data into a databse
